namespace Bennewitz.Ninja.AppServices.Abstractions.Dialogs;
...
public sealed class DialogMessage
{
    ...
    /// <summary>Create a message from an ordered list of inline runs.</summary>
    /// <param name="segments">The runs, in display order.</param>
